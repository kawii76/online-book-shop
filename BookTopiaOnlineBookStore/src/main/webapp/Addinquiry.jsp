...
<div class="contact-section" >
  ...
  <h1 class="header">Insert your inquiry</h1>
  
  <form class="contact-form" action="insertin" method="post">
    <input type="text" class="contact-form-text" placeholder="Title" name="title" required="true">
   
    <textarea class="contact-form-text" placeholder="Inquiry" name="inquiry" required="true"></textarea>
    <input type="submit" class="btnbtn5" value="Submit" onclick="myFunction()">
  </form>
</div>
