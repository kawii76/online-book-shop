...
<div class="centerDiv">
    <h2 style="text-align: center; color:#3d404e;">Inquiry Management</h2> <br>

<form action =Alllist method ="post">	
	<input type="submit" name="button" value="View All Inquiry" class="linkbutton">
</form> 


<form action = Adminlist method ="post">	
	<input type="submit" name="button" value="Admin All Inquiry" class="linkbutton">
</form>	
...
<div class="rightDiv">
<img src="images/admin.png" alt="inquiry" width="700" height="700" class="center" >
</div>
