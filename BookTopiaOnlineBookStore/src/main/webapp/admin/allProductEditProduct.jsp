...
<body>
<div style="color: white; text-align: center; font-size: 30px;">All Orders & Edit Orders <i class='fa fa-list'></i></div>
<%
...
<table>
       ...
       try{
    	   ...
    	   ResultSet rs=st.executeQuery("select *from oproduct");
    	   while(rs.next()){
        %>
          <tr>
