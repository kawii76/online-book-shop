...
%>
          <tr>
            <th scope="col" style="background-color: #FFBF00;">Total:  <i class="fa fa-usd"></i> <%out.println(total); %></th>
            <%if(total>0){ %><th scope="col"style="background-color: #FF0000 ;"><a href="addressPaymentForOrder.jsp"> Proceed to order</a></th><%} %>
          </tr>
        </thead>
        <thead>
          <tr>
