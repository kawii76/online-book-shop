...
function validateForm() {
  let x = document.forms["createRequests"]["supplyID"].value;
  if (x == "") {
    alert("Supply ID Must Be Filled Out");
    return false;
  }
}
</script>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-75" style="width: 25%;">
				<input type="text" id="supplyID" name="supplyID" Required>
			</div>&nbsp;&nbsp;
			<div>&nbsp;&nbsp;&nbsp;Supplier order ID should be Ex: Senarathna - SPxxx or Karunarathna - KPxxx </div>
		</div>
		<br>
		<!-- Supply order no -->
		<!-- Supply order Title -->
		...
		<div class="pageNav" >
			<div class="left" id="center">
				<input type="submit" name="submit" value="Place The Order" onclick="myFunction()">
			</div>
		<!-- Submit button -->
		<!-- Clear Button -->
			<div class="center2" id="center">
				<input type="reset" value="Clear All Feilds">
			</div>
		</div>
		<!-- Clear Button -->
		</form>
...
<script>
function myFunction() {
  alert("Book Supply Order Created Successful");
}
</script> 
</html>